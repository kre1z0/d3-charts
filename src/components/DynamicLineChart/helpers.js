...
export const getTranslate = (element, allAxis) => {
  const translate = (element.attr("transform") || `translate(0, 0)`).match(/(-?[0-9\.]+)/g);
  return allAxis ? translate : Math.abs(translate[0]);
};
